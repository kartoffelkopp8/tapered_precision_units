...
architecture RTL of takum_logarithmic_encoder is
    signal s_c_raw    : std_logic_vector(8 downto 0); 
    signal s_c_wo_d   : std_logic_vector(7 downto 0);
    signal s_mant_raw : std_logic_vector(G_N + 3 - 9 downto 0); 
    signal s_dir      : std_logic;

    signal s_cond_inv_c : std_logic_vector(7 downto 0);
    signal s_precursor  : std_logic_vector(7 downto 0); 
    ...
    signal s_c_mant_pre_shift : std_logic_vector(G_N + 9 - 1 downto 0); 
...
begin
    ...
    s_c_m <= s_c_mant_shftd(s_c_mant_shftd'high - 7 downto 0); 
